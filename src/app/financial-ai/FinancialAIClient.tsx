...
interface FinancialAIClientProps {
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <nav className="space-y-2">
                  ...
                  {initialCategories.map((category) => {
                    ...
                    return (
                      <Link
                        key={category}
                        href={`/financial-ai?category=${encodeURIComponent(category)}`}
                        className={`block px-4 py-2.5 rounded-full text-sm font-medium transition-all ${
          ...
          <div className="flex-1 min-w-0">
            <div className="space-y-8">
              {posts.map((post) => (
                <Link key={post.slug} href={`/financial-ai/${post.slug}`}>
                  <article
...
export default function FinancialAIClient(props: FinancialAIClientProps) {
  return (
    <Suspense
      fallback={
        <div
