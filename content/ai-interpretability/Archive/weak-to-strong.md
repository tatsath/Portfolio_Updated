...
Therefore, weak-to-strong generalization depends on the strong student not being _too_ good at obtaining low predictive loss. Burns et al. find that, at least in some cases, the student eventually "overfits" to the supervisor and ground-truth performance starts to decrease by the end of training.
