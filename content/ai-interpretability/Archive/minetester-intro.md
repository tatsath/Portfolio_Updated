...
_An example custom wrapper that makes the task easier by locking an action for the agent._
...
\*_Note: The following section is best understood by following along with the notebook and model policy described [here](https://github.com/EleutherAI/minetest-interpretabilty-notebook)._
