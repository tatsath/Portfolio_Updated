...
**"Chain-of-Thought Is Not Explainability"** (Barez et al., Oxford 2025) surveyed over 1,000 CoT papers and argues that treating CoT as explanation without checking faithfulness is a systematic mistake. The paper states:
...
Anthropic's research makes the same point more directly. In **"Reasoning models don't always say what they think"** (Anthropic, 2023), they state:
...
The unfaithfulness problem is particularly dangerous in regulated industries. The European Securities and Markets Authority (ESMA) 2025 report on LLMs in finance identifies opacity and hallucination as major blockers for LLM adoption in financial services. Regulatory reports stress that unreliable reasoning can lead to systematically biased or unsafe outputs.
...
The most compelling evidence for CoT unfaithfulness comes from intervention experiments. **"Measuring Faithfulness in Chain-of-Thought Reasoning"** (Lanham et al., Anthropic 2023) defines faithfulness as "does the answer actually depend on this CoT?" and tests it through several intervention methods:
...
Yeo et al. (2024) in **"How Interpretable are Reasoning Explanations from Prompting Large Language Models?"** explicitly evaluate CoT explanations on faithfulness, robustness, and utility. They measure faithfulness by checking whether small changes to the reasoning (or to the input) lead to changes in the answer in a way consistent with the explanation.
...
Barez et al. (2025) argue that this plausibility bias is inherent to how language models work. Models generate text that fits patterns they've seen in training data, not text that necessarily reflects their actual reasoning process. The result is explanations that look convincing but may be unfaithful.
...
ESMA's 2025 report on LLMs in finance emphasizes that opacity and hallucination are major blockers for adoption. The report recommends mechanistic interpretability approaches—inspecting internal activations, circuits, and features—as a way to provide deeper assurance than surface-level explanations.
...
- Barez, F., et al. (2025). "Chain-of-Thought Is Not Explainability." Oxford Martin AIGI. https://aigi.ox.ac.uk/wp-content/uploads/2025/07/Cot_Is_Not_Explainability.pdf

- Anthropic (2023). "Reasoning models don't always say what they think." https://www.anthropic.com/research/reasoning-models-dont-say-think

- Lanham, T., et al. (2023). "Measuring Faithfulness in Chain-of-Thought Reasoning." Anthropic. https://www.anthropic.com/research/measuring-faithfulness-chain-of-thought

- Turpin, M., et al. (2023). "Language Models Don't Always Say What They Think: Unfaithful Explanations in Chain-of-Thought Prompting." arXiv:2305.04388. https://arxiv.org/abs/2305.04388

- Yeo, W. J., et al. (2024). "How Interpretable are Reasoning Explanations from Prompting Large Language Models?" NAACL 2024. arXiv:2402.04614. https://arxiv.org/abs/2402.04614

- ESMA (2025). "LLMs in Finance - ILB ESMA Turing Report." https://www.esma.europa.eu/sites/default/files/2025-06/LLMs_in_finance_-_ILB_ESMA_Turing_Report.pdf

- ThinkLess (2025). "ThinkLess: Training-Free Reasoning Acceleration." arXiv:2501.02513. https://arxiv.org/abs/2501.02513

- CoT Hijacking (2024). "Chain-of-Thought Hijacking and Adversarial Prompt Injection." arXiv:2402.04614. https://arxiv.org/abs/2402.04614
