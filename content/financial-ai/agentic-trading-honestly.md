...
date: 2026-04-07
description: "A practitioner's map of AI in the investment workflow: what the platforms actually do beneath the marketing, where real value sits, and the trap nobody puts on the slide."
categories:
 - Opinion
draft: false
ShowToc: true
...
3. **Research and analysis.** Reconciling numbers, reading management language, comparing to a thesis. Strong. This is the earnings-season workflow covered earlier in this series. Failure mode: a confident summary that's subtly wrong.
...
- **Research-first, always.** Automate ideation, data, research, and monitoring, the reversible, high-value, low-risk stages, and earn the right to touch execution later, if ever. This is the same research-first principle from the first essay in this series, and it is what every serious player above actually does.
...
The agentic-trading question is not whether to use AI but which keys to hand over and which to keep. Automate the reversible stages — ideation, data, research, monitoring — and make anything that touches live execution earn its place. The honest way to check yourself is to map where your firm uses AI today: if every use sits in the green research-and-monitoring zone, with source-linked outputs and a human reviewing before money moves, you are doing this right. If something is being sold to you in the red autonomous-execution zone, three questions settle it — how do you correct for the number of strategies tested, can you show the evidence behind every decision, and where is the kill switch? The order is becoming a commodity; the judgment about whether to trust it is the edge, and the quality of those answers tells you everything.

---

## References

- <a id="ref-1"></a>**1. Bloomberg** - [*Robinhood Launches AI Stock Trading*](https://www.bloomberg.com/news/articles/2026-05-27/robinhood-launches-ai-stock-trading-purchases-on-credit-cards) (May 2026)
...
- <a id="ref-5"></a>**5. AI Street** - [*AI in Mid-Frequency Trading*](https://www.ai-street.co/p/ai-in-mid-frequency-trading) (2026)
- <a id="ref-6"></a>**6. Kang et al.** - [*Win Fast or Lose Slow: Balancing Speed and Accuracy in LLMs*](https://arxiv.org/abs/2505.19481) (2025)
- <a id="ref-7"></a>**7. Xiao et al. (UCLA / MIT)** - [*TradingAgents: Multi-Agents LLM Financial Trading Framework*](https://arxiv.org/abs/2412.20138) (2024)
- <a id="ref-8"></a>**8. arXiv** - [*Large Language Model Agent in Financial Trading: A Survey*](https://arxiv.org/pdf/2408.06361) (2024)
...
- <a id="ref-11"></a>**11. Anthropic** - [*Claude for Financial Services: Data Partnerships*](https://fortune.com/2026/05/05/anthropic-wall-street-financial-services-agents-jamie-dimon/) (2026)
- <a id="ref-12"></a>**12. Anthropic** - [*Finance Agents: Drafts for Qualified Human Review*](https://fortune.com/2026/05/05/anthropic-wall-street-financial-services-agents-jamie-dimon/) (2026)
- <a id="ref-13"></a>**13. Korea Times** - [*LinqAlpha Builds AI to Help Hedge Funds Maximize Alpha*](https://www.koreatimes.co.kr/business/banking-finance/20250312/linqalpha-builds-ai-to-help-hedge-funds-maximize-alpha) (2025)
- <a id="ref-14"></a>**14. AWS ML Blog** - [*How LinqAlpha Assesses Investment Theses on Amazon Bedrock*](https://aws.amazon.com/blogs/machine-learning/how-linqalpha-assesses-investment-theses-using-devils-advocate-on-amazon-bedrock/) (2026)
- <a id="ref-15"></a>**15. LinqAlpha** - [*Introducing the LinqAlpha API*](https://www.getlinq.com/Blog/introducing-linqalpha-api-for-hedge-funds-and-asset-managers)
...
- <a id="ref-21"></a>**21. Digital.Finance** - [*Perplexity AI Finance Features*](https://digital.finance/blog/perplexity-ai-finance-features-revolutionizing-financial-research-and-insights)
- <a id="ref-22"></a>**22. SalesSo** - [*How to Access Perplexity Finance*](https://salesso.com/blog/how-to-access-perplexity-finance-final/) (2025)
- <a id="ref-23"></a>**23. IMD** - [*Citigroup AI Maturity 2025*](https://www.imd.org/entity-profile/citigroup-ai-maturity-2025/) (2025)
- <a id="ref-24"></a>**24. Banking Dive** - [*Citi Rolls Out Agentic AI Tools (Stylus Workspaces)*](https://www.bankingdive.com/news/citi-agentic-AI-tools-stylus-workspaces/760868/) (2025)
- <a id="ref-25"></a>**25. const-ins** - [*How Citi's CTO Measures AI ROI (the 'Capacity' Metric)*](https://const-ins.com/how-citis-cto-is-rolling-out-new-gen-ai-productivity-tools-to-more-employees-across-the-globe/) (2025)
- <a id="ref-26"></a>**26. Yun et al. (Qraft Technologies)** - [*QuantEvolve: Automating Quantitative Strategy Discovery*](https://arxiv.org/abs/2510.18569) (2025)
- <a id="ref-27"></a>**27. QuantConnect** - [*Developing Trading Strategies with Genetic Algorithms*](https://www.quantconnect.com/forum/discussion/2396/developing-trading-strategies-with-genetic-algorithms/)
...
- <a id="ref-31"></a>**31. Man Group** - [*What AI Can (and Can't Yet) Do for Alpha*](https://www.man.com/insights/what-ai-can-do-for-alpha) (November 2025)
...
- <a id="ref-34"></a>**34. AI Street** - [*Hedge Fund Coverage: Hudson River Trading's Foundation Models*](https://www.ai-street.co/) (2026)
- <a id="ref-35"></a>**35. U.S. SEC** - [*Division of Examinations: FY2026 Examination Priorities*](https://www.sec.gov/about/divisions-offices/division-examinations/examination-priorities) (November 2025)
- <a id="ref-36"></a>**36. U.S. SEC** - [*Withdrawal of the Predictive Data Analytics Proposal*](https://www.sec.gov/rules-regulations/2025/06/s7-12-23) (June 2025)
- <a id="ref-37"></a>**37. FINRA** - [*2026 Annual Regulatory Oversight Report*](https://www.finra.org/media-center/newsreleases/2025/finra-publishes-2026-regulatory-oversight-report-empower-member-firm) (December 2025)
