...
> **Working with me.** I help funds and RIAs cut through the agentic-trading noise: mapping where AI belongs in the workflow, validating strategies against the overfitting an agent makes worse, and building the evidence and risk-control layer before anything touches execution. I do not sell a trading system or take a side on vendors, so the judgment is the product, not a platform. The companion to this essay is a one-page map of where AI belongs in a trading workflow and a readiness checklist covering overfitting correction, the evidence trail, the kill switch, and the fiduciary line. If you have seen the platforms and do not know where to start, that map and a conversation are the place to begin.
