...
## Where retrieval fails, specifically
...
- <a id="ref-1"></a>**1. Databricks** - [*OfficeQA Pro: An Enterprise Benchmark for End-to-End Grounded Reasoning*](https://arxiv.org/abs/2603.08655) (March 2026)
- <a id="ref-2"></a>**2. LlamaIndex** - [*ParseBench: A Document Parsing Benchmark for AI Agents*](https://arxiv.org/abs/2604.08538) (April 2026)
- <a id="ref-3"></a>**3. Islam et al. (Stanford / Patronus AI)** - [*FinanceBench: A New Benchmark for Financial Question Answering*](https://arxiv.org/abs/2311.11944) (2023)
- <a id="ref-4"></a>**4. Kim & Huang (Daloopa)** - [*FinRetrieval: A Benchmark for Financial Data Retrieval by AI Agents*](https://arxiv.org/abs/2603.04403) (January 2026)
- <a id="ref-5"></a>**5. AI Street** - [*On Retrieval Completeness in Agentic Reading*](https://www.ai-street.co/) (2026)
- <a id="ref-6"></a>**6. Gradient Flow / Ben Lorica** - [*What's Emerging in Financial AI*](https://gradientflow.substack.com/p/emerging-ai-patterns-in-finance-what) (January 2026)
- <a id="ref-7"></a>**7. FINRA** - [*2026 Annual Regulatory Oversight Report*](https://www.finra.org/media-center/newsreleases/2025/finra-publishes-2026-regulatory-oversight-report-empower-member-firm) (December 2025)
